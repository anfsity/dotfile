...
for i = 1, 10 do
 hl.bind("SUPER + ALT + code:"..numberkey[i], smartWorkspaceAction("movetoworkspacesilent", i) )
end
--# keypad numbers
for i = 1, 10 do
 hl.bind("SUPER + ALT + code:"..numpadkey[i], smartWorkspaceAction("movetoworkspacesilent", i) )
end
...
--# We use raw keycodes because some keyboard layouts register number keys as different chars. The codes can be verified with `wev`
for i = 1, 10 do
 hl.bind("SUPER + code:"..numberkey[i], smartWorkspaceAction("workspace", i) )
end
--# keypad numbers
for i = 1, 10 do
 hl.bind("SUPER + code:"..numpadkey[i], smartWorkspaceAction("workspace", i) )
end
